...
func renderStorageCard(integrationID string, locations []store.StorageLocation) string {
	...
	var locRows string
	if len(locations) == 0 {
		locRows = `<p class="is-size-7 has-text-grey mb-3">No storage locations added. Add an S3 key prefix to set where recordings are uploaded.</p>`
	} else {
...
<div class="mt-3 pt-3" style="border-top: 1px solid var(--bulma-border)">
  ...
  <div x-show="adding" style="display:none">
    ...
    <div class="columns is-mobile">
      ...
      <div class="column">
        <label class="label is-small">Key Prefix</label>
        <div class="control">
          <input
            type="text"
            x-model="path"
...
<div class="box">
  <div class="is-flex is-justify-content-space-between is-align-items-center mb-4">
    <h2 class="title is-6 mb-0">S3 Storage — Key Prefixes</h2>
  </div>
